...
Пока тексты лежат рядом (`data/inbox`, `data/readers`) **или** он сам ходит в интернет: поиск по публичным страницам, потом Википедия, плюс официальные доки если тема знакома (Битрикс → site:dev.1c-bitrix.ru). «поучи python в интернете» — жуёт короткие строки в веса, не сырой HTML. «изучи как делается ЦРМ в битриксе» — ищет, коротко записывает, **сам решает, чему учиться дальше**. Localhost и частные сети закрыты. В тетрадь попадает отжатый текст, не вся страница academy.
